...
#define FWRETRACT
  ...
  #define RETRACT_RECOVER_FEEDRATE      4   // (mm/s) Default feedrate for recovering from retraction
  #define RETRACT_RECOVER_FEEDRATE_SWAP 4   // (mm/s) Default feedrate for recovering from swap retraction
