...
#define STRING_CONFIG_H_AUTHOR "(Florinescu)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 85.73
  #define DEFAULT_bedKi 14.43
  #define DEFAULT_bedKd 339.92
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 908 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -2, -1.90 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 32, 30, 38, 13 } // (mm) Left, Front, Right, Back insets
...
#define PREHEAT_2_LABEL       "Tramming"
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  30, -12, Z_MIN_POS } }
  #define NOZZLE_CLEAN_END_POINT   { {  50, -5, Z_MIN_POS } }
  ...
  #define NOZZLE_CLEAN_CIRCLE_MIDDLE { {  40, -8.5, Z_MIN_POS } }
